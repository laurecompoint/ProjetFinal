        ...
        <main class="col-9">
            ...
            <form action="index.php?page=profile" method="post" class="p-4 row flex-column" enctype="multipart/form-data">
                ...
                <div class="form-group col-sm-8">
                    ...
                    <input class="form-control" value="<?php echo $user['numerotel']?>" name="numerotel"  placeholder="numerotel">
                </div>
                <div class="form-group col-sm-8">
                ...
                <div class="form-group col-sm-8">
                    ...
                    <input class="form-control" value="<?php echo $user['ville']?>" name="ville"  placeholder="ville">
                </div>
                <div class="form-group col-sm-8">
